                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('kompetensi-keahlian.update', $kompetensi) }}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <div class="mb-3">
                                        <label for="kompetensi_keahlian">Kompetensi Keahlian</label>
                                        <input type="text" class="form-control 
                                    @error('kompetensi_keahlian') is-invalid @enderror" id="kompetensi_keahlian" placeholder="Kompetensi Keahlian" name="kompetensi_keahlian" value="{{old('kompetensi_keahlian', $kompetensi->kompetensi_keahlian)}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" placeholder="Nama Kepala Program" id="nama_guru" name="nama_guru" aria-label="nama_guru" value="{{ old('nama_guru', optional($kompetensi->fguru)->nama_guru) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran" placeholder="Tahun Ajaran" name="tahun_ajaran" value="{{ old('tahun_ajaran', $kompetensi->tahun_ajaran) }}">
                                        @error('tahun_ajaran')
