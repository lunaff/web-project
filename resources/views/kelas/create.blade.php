                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title mb-0">Add New Data Kelas</h4>
                            </div>                            
                            <div class="card-body">
                                <form action="{{ route('kelas.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" placeholder="Nama Wali Kelas" id="nama_guru" name="nama_guru" aria-label="nama_guru" value="{{ old('nama_guru') }}" aria-describedby="cari" readonly>
                                            <div class="input-group-append">
                                                    ...
                                                    <table class="table table-hover table-bordered table-stripped" id="example2">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="btn btn-primary btn-xs" onclick="pilih('{{ $k->id }}', '{{ $k->kompetensi_keahlian }}')" data-bs-dismiss="modal">
                                                                        Pilih
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <table class="table table-hover table-bordered table-stripped" id="example2">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="#" class="btn btn-primary btn-xs" onclick="pilih1('{{ $k->nama_guru }}', '{{ $k->nip }}')" data-bs-dismiss="modal">
                                                                        Pilih
                                                                    </a>
                                                                </td>
                                                            </tr>
