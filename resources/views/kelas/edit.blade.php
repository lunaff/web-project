                            ...
                            <div class="card-body">
                                <form action="{{ route('kelas.update', $kelas) }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran" placeholder="Tahun Ajaran" name="tahun_ajaran" value="{{ old('tahun_ajaran', $kelas->tahun_ajaran) }}">
                                        @error('tahun_ajaran')
                                        <span class="text danger">{{ $message }}</span>
                                        @enderror
                                    </div>
